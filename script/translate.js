...
window.translations = {
    'pt': {
        ...
        'chat_name_anadias': 'Ana Dias',
        'chat_name_anamaria': 'Ana Maria',
        'chat_name_joseporto': 'José Porto',
        ...
        // Gerenciar Ocorrências (admin)
        'filters_search_placeholder': 'Buscar por ID ou descrição...',
        'manage_occurrences_title': 'Gerenciamento de Ocorrências',
        'stats_pending': 'Pendentes',
        'stats_in_progress': 'Em Andamento',
        'stats_resolved': 'Resolvidas (Hoje)',
        'filter_status_all': 'Status: Todos',
        'filter_status_pending': 'Pendente',
        'filter_status_in_progress': 'Em Andamento',
        'filter_status_resolved': 'Resolvida',
        'filter_priority_all': 'Prioridade: Todas',
        'priority_high': 'Alta',
        'priority_medium': 'Média',
        'priority_low': 'Baixa',
        'apply_filters_btn': 'Aplicar Filtros',
        'table_th_id': 'ID',
        'table_th_description': 'Descrição (Resumo)',
        'table_th_status': 'Status',
        'table_th_priority': 'Prioridade',
        'table_th_neighborhood': 'Bairro',
        'table_th_action': 'Ação',
        'status_pending_label': 'Pendente',
        'status_in_progress_label': 'Em Andamento',
        'status_resolved_label': 'Resolvida',
        'details_button': 'Detalhes',
        // Corrigir chave de bairro usada em alguns templates
        'cid_bairro3': 'Avenida Principal',
    ...
    'en': {
        ...
        // Manage occurrences (admin)
        'filters_search_placeholder': 'Search by ID or description...',
        'manage_occurrences_title': 'Manage Occurrences',
        ...
        'table_th_id': 'ID',
        'table_th_description': 'Description (Summary)',
        'table_th_status': 'Status',
        'table_th_priority': 'Priority',
        'table_th_neighborhood': 'Neighborhood',
    ...
    'es': {
        ...
        'btn_register_occurrence': 'Registrar Incidencia',
         ...
         'filters_search_placeholder': 'Buscar por ID o descripción...',
         'manage_occurrences_title': 'Gestión de Incidencias',
         'stats_pending': 'Pendientes',
        'stats_in_progress': 'En Progreso',
        'stats_resolved': 'Resueltas (Hoy)',
        'filter_status_all': 'Estado: Todos',
        'filter_status_pending': 'Pendiente',
        'filter_status_in_progress': 'En Progreso',
        'filter_status_resolved': 'Resuelta',
        'filter_priority_all': 'Prioridad: Todas',
        'priority_high': 'Alta',
        'priority_medium': 'Media',
        'priority_low': 'Baja',
        'apply_filters_btn': 'Aplicar Filtros',
        'table_th_id': 'ID',
        'table_th_description': 'Descripción (Resumen)',
        'table_th_status': 'Estado',
        'table_th_priority': 'Prioridad',
        'table_th_neighborhood': 'Vecindario',
        'table_th_action': 'Acción',
        'status_pending_label': 'Pendiente',
        'status_in_progress_label': 'En Progreso',
        'status_resolved_label': 'Resuelta',
    ...
    'fr': {
        ...
        'btn_register_occurrence': 'Enregistrer l\'Incidence',
         ...
         'filters_search_placeholder': 'Rechercher par ID ou description...',
         'manage_occurrences_title': 'Gestion des Incidents',
         'stats_pending': 'En attente',
        'stats_in_progress': 'En cours',
        'stats_resolved': 'Résolues (Aujourd\'hui)',
        'filter_status_all': 'Statut : Tous',
        'filter_status_pending': 'En attente',
        'filter_status_in_progress': 'En cours',
        'filter_status_resolved': 'Résolu',
        'filter_priority_all': 'Priorité : Toutes',
        'priority_high': 'Haute',
        'priority_medium': 'Moyenne',
        'priority_low': 'Faible',
        'apply_filters_btn': 'Appliquer les filtres',
        'table_th_id': 'ID',
        'table_th_description': 'Description (Résumé)',
        'table_th_status': 'Statut',
        'table_th_priority': 'Priorité',
        'table_th_neighborhood': 'Quartier',
        'table_th_action': 'Action',
        'status_pending_label': 'En attente',
        'status_in_progress_label': 'En cours',
        'status_resolved_label': 'Résolu',
